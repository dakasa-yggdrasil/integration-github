...
import (
	...
	"github.com/dakasa-yggdrasil/integration-github/controllers/message"
	ad "github.com/dakasa-yggdrasil/integration-github/internal/adapter"
)

// main bootstraps the github adapter with transport selected at
// runtime:
//
...
func main() {
	...
	case "", "http", "http_json":
		...
		a.ListenHTTP(addr)
		logger.Info("integration-github adapter starting on HTTP", zap.String("addr", addr))
	case "amqp", "rabbitmq":
		...
		logger.Info("integration-github adapter starting on AMQP")
	default:
